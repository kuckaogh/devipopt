...
if sys.platform == 'win32':
    ...
    IPOPT_ICLUDE_DIRS=['./ipopt_bin/Ipopt-3.9.2-win32-win64-dll/include/coin']
    IPOPT_LIBS=['Ipopt', 'IpOptFSS']
    IPOPT_LIB_DIRS=['./ipopt_bin/Ipopt-3.9.2-win32-win64-dll/lib/win32/Release MKL']
    IPOPT_DLL=['Ipopt39.dll', 'IpoptFSS39.dll']
else:
    print 'Error...'
